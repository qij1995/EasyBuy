...
import static com.my.easybuy.R.id.rl_receive;
...
//    private String saleName;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View view= LayoutInflater.from(context).inflate(R.layout.list_item_my_evaluate,null);
        ImageView iv= (ImageView) view.findViewById(R.id.iv_goods);
        TextView tv_des= (TextView) view.findViewById(R.id.tv_des);
        TextView tv_price= (TextView) view.findViewById(R.id.tv_price);
        TextView tv_number= (TextView) view.findViewById(R.id.tv_number);
        TextView tv_num = (TextView) view.findViewById(R.id.tv_num);
        RelativeLayout rl_evaluate = (RelativeLayout) view.findViewById(R.id.rl_evaluate);
